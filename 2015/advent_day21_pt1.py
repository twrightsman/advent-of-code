...
lowest_set_cost = 1000
for equipment_set in equipment_sets:
    set_cost, player_DMG, player_AMR = set_stats(equipment_set)

    if win(player_MAXHP, player_DMG, player_AMR, boss_MAXHP, boss_DMG, boss_AMR):
        if set_cost < lowest_set_cost:
            lowest_set_cost = set_cost

print(lowest_set_cost)